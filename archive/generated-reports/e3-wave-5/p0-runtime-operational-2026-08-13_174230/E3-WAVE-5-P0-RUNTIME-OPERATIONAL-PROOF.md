...
| READ_ONLY_RUNTIME | RUNTIME_BOUNDARY | http://localhost:3000/api/mastermind/decision-package | PASS | RUNTIME_PROVEN_READ_ONLY | HTTP 405 |

## Limits and next gate

- A PASS test proves only the test contract it exercised; it does not automatically prove operational state effects.
- A PARTIAL result preserves explicitly pending checks reported by an existing test; it is not silently converted to PASS.
