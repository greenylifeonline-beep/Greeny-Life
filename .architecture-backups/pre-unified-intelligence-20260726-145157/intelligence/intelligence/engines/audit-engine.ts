...
const SOURCES = [
    ...
    {
        name:"MASTER",
        file:"data/05_master_products.json"
    },

    {
        name:"MIGRATED",
        file:"data/migrated_products.json"
    },

    {
        name:"LEGACY",
        file:"data/legacy/products.json"
    }
...
function validateProduct(
    ...
    const sourceType:ProductSource =
        ...
        source.includes("05_master_products")
        ?
        "master"

        :

        source.includes("migrated")
        ?
        "migrated"
