...
$Harness = Join-Path $Runtime "a8_shadow_runtime_certification.py"
...
Write-Host ""
Write-Host "======================================================================"
Write-Host " RAIOS V9.0-A8 INSTALLER"
Write-Host "======================================================================"

& $Python -m py_compile $Harness

if ($LASTEXITCODE -ne 0) {
    throw "A8_HARNESS_COMPILE_FAILED"
}

Write-Host "A8_HARNESS_COMPILE = PASS"

Write-Host ""
Write-Host "=== EXECUTING A8 ==="

& $Python $Harness

if ($LASTEXITCODE -ne 0) {
    throw "RAIOS_V9_A8_CERTIFICATION_FAILED"
}

Write-Host ""
Write-Host "======================================================================"
Write-Host " A8 INSTALLER FINISHED"
Write-Host "======================================================================"