...
$Harness = Join-Path $Runtime "a11_limited_act_guardian_certification.py"
...
Write-Host ""
Write-Host "======================================================================"
Write-Host " RAIOS V9.0-A11 INSTALLER"
Write-Host "======================================================================"

& $Python -m py_compile $Harness

if ($LASTEXITCODE -ne 0) {
    throw "A11_HARNESS_COMPILE_FAILED"
}

Write-Host "A11_HARNESS_COMPILE = PASS"

Write-Host ""
Write-Host "=== EXECUTING A11 ==="

& $Python $Harness

if ($LASTEXITCODE -ne 0) {
    throw "RAIOS_V9_A11_CERTIFICATION_FAILED"
}

Write-Host ""
Write-Host "======================================================================"
Write-Host " A11 INSTALLER FINISHED"
Write-Host "======================================================================"