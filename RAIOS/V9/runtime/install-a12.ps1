...
$Harness = Join-Path $Runtime "a12_runtime_supervisor_certification.py"
...
Write-Host ""
Write-Host "======================================================================"
Write-Host " RAIOS V9.0-A12 INSTALLER"
Write-Host "======================================================================"

& $Python -m py_compile $Harness

if ($LASTEXITCODE -ne 0) {
    throw "A12_HARNESS_COMPILE_FAILED"
}

Write-Host "A12_HARNESS_COMPILE = PASS"

Write-Host ""
Write-Host "=== EXECUTING A12 ==="

& $Python $Harness

if ($LASTEXITCODE -ne 0) {
    throw "RAIOS_V9_A12_CERTIFICATION_FAILED"
}

Write-Host ""
Write-Host "======================================================================"
Write-Host " A12 INSTALLER FINISHED"
Write-Host "======================================================================"